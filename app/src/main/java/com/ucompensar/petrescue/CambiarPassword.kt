...
import com.ucompensar.petrescue.databinding.ActivityCambiarPasswordBinding
...
class CambiarPassword : AppCompatActivity() {
    ...
    private fun validarInformacion() {
        ...
        if (pass_actual.isEmpty()) {
            binding.etPassActual.error = "Ingrese contraseña"
            ...
            binding.etRPassNueva.error = "No coninciden las contraseñas"
            binding.etRPassNueva.requestFocus()
        } else {
            autenticarUsuario()
        }
    ...
    private fun autenticarUsuario() {
        ...
        val authCredential =
            EmailAuthProvider.getCredential(firebaseUser.email.toString(), pass_actual)
        firebaseUser.reauthenticate(authCredential)
            ...
            .addOnFailureListener { e ->
                ...
                Toast.makeText(
                    this, "fallo la autenticacion debido a ${e.message}",
                    Toast.LENGTH_SHORT
                ).show()
    ...
    private fun actualizarPassword() {
        ...
        firebaseUser.updatePassword(pass_nueva)
            .addOnSuccessListener {
                progressDialog.dismiss()
                Toast.makeText(
                    this, "La contraseña se ha actualizado",
                    Toast.LENGTH_SHORT
                ).show()
                cerrarSesion()
            }
